-- ================================================================
-- CRIAR FUNÇÃO PARA ATUALIZAR VALORES REALIZADOS DAS METAS
-- ================================================================
-- Esta função recalcula os valores realizados das metas mensais
-- com base nas vendas e descontos registrados
-- ================================================================
...
COMMENT ON FUNCTION public.atualizar_valores_realizados_metas(text, integer, integer, bigint) IS
'Atualiza os valores realizados das metas mensais com base nas vendas e descontos. Nota: Esta função NÃO suporta múltiplas filiais via string separada por vírgulas.';

GRANT EXECUTE ON FUNCTION public.atualizar_valores_realizados_metas TO authenticated;
GRANT EXECUTE ON FUNCTION public.atualizar_valores_realizados_metas TO anon;

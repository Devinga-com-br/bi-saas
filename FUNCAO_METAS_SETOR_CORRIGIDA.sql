-- ============================================================================
-- FUNÇÃO CORRIGIDA: get_metas_setor_report_optimized
-- Baseada nas colunas que REALMENTE EXISTEM na tabela metas_setor
-- ============================================================================
...
BEGIN
  ...
  EXECUTE format($query$
    ...
    grouped_by_date AS (
      ...
      SELECT
        mf.data,
        TO_CHAR(mf.data, 'TMDay') as dia_semana,
        jsonb_agg(
          jsonb_build_object(
...
-- Ver os logs
-- Verifique os logs do Supabase para ver as mensagens RAISE NOTICE

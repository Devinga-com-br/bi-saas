...
-- =====================================================
-- Copie TODO o conteúdo abaixo e execute no Supabase
-- Dashboard → SQL Editor → New Query → Colar → Run
-- =====================================================

-- Drop da função antiga (se existir)
DROP FUNCTION IF EXISTS public.get_produtos_sem_vendas(
  TEXT, TEXT, INTEGER, DATE, TEXT, TEXT, TEXT, TEXT
);

-- Criar função otimizada com paginação
...
-- =====================================================
-- SUCESSO! Função criada.
-- Agora crie os índices (próximo passo)
-- =====================================================

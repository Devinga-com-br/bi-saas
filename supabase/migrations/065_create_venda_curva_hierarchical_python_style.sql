-- Migration: Create hierarchical sales by curve report (Python style)
-- Description: Creates function to generate hierarchical sales report grouped by department levels
...
CREATE TYPE venda_curva_result AS (
  tipo TEXT,
  nome TEXT,
  segmento_pai TEXT,

-- Migration: Fix get_metas_setor_report function parameter order
-- Description: Recreate function to match API call parameters
...
-- Recreate function with parameter order matching API calls

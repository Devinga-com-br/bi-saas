...
-- Otimização do Relatório Venda por Curva
-- ============================================

-- STEP 1: Create helper function for indexes
...
-- STEP 2: Create optimized report function
...
'Optimized Venda por Curva report function.
Performance improvements:
- Single table scan (vs previous 2 scans)
- Date range optimization for index usage
- Reduced I/O by ~50%
Created: 2025-10-21';

-- STEP 3: Apply indexes to your schemas
-- Uncomment the schemas you want to optimize:
...
FROM pg_indexes 
WHERE schemaname IN ('okilao') -- add your schemas here
  AND indexname LIKE 'idx_%'
ORDER BY schemaname, tablename, indexname;

-- Done! The report should now load much faster.

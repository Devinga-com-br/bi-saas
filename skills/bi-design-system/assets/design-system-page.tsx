...
import { ArrowDown, ArrowUp, ArrowUpDown, ChevronDown, ChevronUp, LayoutDashboard, Sparkles } from 'lucide-react'
    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-sm text-muted-foreground">
          Base real de UI usada no sistema para iniciar novos modulos com consistencia.
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Padrão de titulo e descricao (Dashboard 360).</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex flex-col gap-2">
            ...
            <p className="text-sm text-muted-foreground">
              Analise consolidada de vendas, lucro e performance por periodo
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Filters Bar</CardTitle>
          <CardDescription>Padrão de filtros do Dashboard 360.</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="rounded-md border p-4">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:gap-4">
              ...
              <DashboardFilter onPeriodChange={(inicio, fim, tipo) => setPeriodo({ inicio, fim, tipo })} />
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Toasts (Metas)</CardTitle>
          <CardDescription>Padrao de feedback usado em Metas.</CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <div>
            ...
            <CardDescription>Padrão "Vendas por Filial" do Dashboard 360.</CardDescription>
          </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Padrao utilizado em Despesas.</CardDescription>
        </CardHeader>

-- ================================================================
-- APLICAR DESCONTOS NA GERAÇÃO DE METAS MENSAIS
-- ================================================================
-- Esta função gera metas baseadas em dados históricos e precisa
-- considerar os descontos tanto no valor de referência quanto no realizado
-- ================================================================
...
COMMENT ON FUNCTION public.generate_metas_mensais(text, bigint, integer, integer, numeric, date) IS
'Gera metas mensais com valores LÍQUIDOS (vendas - descontos) tanto para referência quanto realizado';
